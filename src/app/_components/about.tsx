        ...
        <section className="bg-[#FDF6ec] py-16">
            <div className="container px-4 mx-auto">
                ...
                <div className="space-y-6 mt-3 ">
                        ...
                        <p>
                        Somos uma Igreja de identidade Reformada. Prezamos pelo ensino fiel da Bíblia Sagrada,
                        a qual é nossa única regra de fé e de prática,  o Evangelho de Cristo Jesus, o qual nasceu,
                        morreu e ressuscitou e que voltará para buscar os seus filhos.

                        Faça-nos uma visita! Você e toda a sua família serão acolhidos e
                        certamente aprenderão mais do Senhor Jesus. Lembre-se, apenas Cristo
                        pode te dar vida eterna e transformar a sua vida!
                        </p>
                        <ul className="space-y-4">
                            ...
                            <li className="mb-10 flex items-center gap-2 font-bold"><Check className="text-green-950"/>Culto - Todos os Domingos a partir das 18h30</li>
                        </ul>
